...
[**🚀 Live Dashboard**](https://ofds2lscxah5g8pgafsdda.streamlit.app/) &nbsp;•&nbsp; [**LinkedIn**](#) &nbsp;•&nbsp; [**Resume**](#) &nbsp;•&nbsp; [**Portfolio**](#)
...
<p align="center">
  <img src="assets/home_overview.png" alt="Dashboard Home Page Screenshot" width="850">
</p>
...
**🔗 Live Demo:** [ofds2lscxah5g8pgafsdda.streamlit.app](https://ofds2lscxah5g8pgafsdda.streamlit.app/)

### 🏠 Home
*(Full landing view shown at the top of this README.)*

<p align="center">
  <img src="assets/home_trend.png" alt="Full-History Daily Demand Trend" width="800">
  <br>
  <em>Full-history daily demand trend — CA_1 + TX_1 combined</em>
</p>

### 📈 Demand Forecast

<p align="center">
  <img src="assets/demand_forecast_main.png" alt="Demand Forecast — Filters and Product Chart" width="800">
  <br>
  <em>Category/store filters, product search, and actual-vs-forecast chart for the selected product</em>
</p>

<p align="center">
  <img src="assets/demand_forecast_category.png" alt="Demand Forecast — Category Aggregate View" width="800">
  <br>
  <em>Category-level aggregate demand and the downloadable CSV output</em>
</p>

### 📦 Inventory Dashboard

<p align="center">
  <img src="assets/inventory_overview.png" alt="Inventory Dashboard — KPIs and Safety Stock by Category" width="800">
  <br>
  <em>Inventory KPIs and total safety stock required by category</em>
</p>

<p align="center">
  <img src="assets/inventory_risk_analysis.png" alt="Inventory Dashboard — Risk Tier and Reorder Point Distribution" width="800">
  <br>
  <em>Risk-tier distribution and reorder point distribution</em>
</p>

<p align="center">
  <img src="assets/inventory_alerts.png" alt="Inventory Dashboard — Reorder Alert List" width="800">
  <br>
  <em>Highest-priority reorder alert list, filterable and downloadable</em>
</p>

### 🔬 Model Insights

<p align="center">
  <img src="assets/model_comparison_a.png" alt="Model Insights — Comparison A" width="800">
  <br>
  <em>Comparison A — full-catalog, 5-fold Baseline vs. ML performance</em>
</p>

<p align="center">
  <img src="assets/model_comparison_b.png" alt="Model Insights — Comparison B" width="800">
  <br>
  <em>Comparison B — fair three-way comparison, same 180-series sample and final fold</em>
</p>

<p align="center">
  <img src="assets/model_stability_error.png" alt="Model Insights — Fold Stability and Error Analysis" width="800">
  <br>
  <em>Fold-by-fold model stability and detailed error analysis breakdown</em>
</p>
...
| Page | Direct Link |
|---|---|
| Home | [/](https://ofds2lscxah5g8pgafsdda.streamlit.app/) |
| Demand Forecast | [/Demand_Forecast](https://ofds2lscxah5g8pgafsdda.streamlit.app/Demand_Forecast) |
| Inventory Dashboard | [/Inventory_Dashboard](https://ofds2lscxah5g8pgafsdda.streamlit.app/Inventory_Dashboard) |
| Model Insights | [/Model_Insights](https://ofds2lscxah5g8pgafsdda.streamlit.app/Model_Insights) |
...
**Live version:** [ofds2lscxah5g8pgafsdda.streamlit.app](https://ofds2lscxah5g8pgafsdda.streamlit.app/)
